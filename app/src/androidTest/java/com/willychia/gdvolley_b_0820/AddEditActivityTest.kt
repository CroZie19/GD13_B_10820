package com.willychia.gdvolley_b_0820
...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText2.perform(scrollTo(), replaceText("willy"), closeSoftKeyboard())
        ...
        textInputEditText3.perform(scrollTo(), replaceText("10820"), closeSoftKeyboard())
